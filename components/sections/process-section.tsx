        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                {/* Step Card */}
                <div className="glass rounded-2xl p-6 h-full flex flex-col items-center text-center group hover:bg-card/80 transition-all duration-300">
                  {/* Number Badge */}
                  ...
                  {/* Icon */}
                  <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center mb-4 mt-4 group-hover:from-primary/30 group-hover:to-accent/30 transition-all duration-300">
